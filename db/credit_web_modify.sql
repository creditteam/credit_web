...
/**---2016-7-24---**/
ALTER TABLE `cr_reward` MODIFY COLUMN `images`  varchar(1024);
ALTER TABLE `cr_credit` MODIFY COLUMN `debt_proof`  varchar(1024);
...
/** 2016-08-14**/
ALTER TABLE `cr_reward` MODIFY COLUMN `reward_amount`  varchar(32) NULL DEFAULT NULL COMMENT '悬赏金额' AFTER `reward_type`;
...
/***********2016-08-18***************/
ALTER TABLE cr_credit ADD COLUMN deal_team_uid int(11) COMMENT '处置团队ID';
ALTER TABLE cr_blog ADD COLUMN `blog_image`  varchar(64) NULL COMMENT '作者' AFTER `blog_author`;
