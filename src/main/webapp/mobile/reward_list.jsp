    ...
    <jsp:include page="mobile_top_logo.jsp"></jsp:include>
	    <div class="row">
	    	<div class="col-md-12" >
		    	...
		    	<caption style="text-align:center;"><h4>悬赏</h4></caption>
				   <thead>
				      <tr>
				         ...
				         <a class="btn btn-success" href="javascript:void(0)" onclick="toRewardAdd()">发布悬赏</a></th>
				      </tr>
				   </thead>
				   <tbody>
...
function toRewardAdd(){
	if('${userInfo}' == null || '${userInfo}' == ''){
		...
		window.location.href = "${basePath}reward/saveReward?userId=${userInfo.id}";
	}
}
