...
public class MozillaUtil {
	...
	private static String mobileGateWayHeaders[]=new String[]{
		...
		"http://chinamobile.com",//中国移动的诺基亚wap网关，例如：Via=WTP/1.1 http://GDSZ-PB-GW003-WAP07.gd.chinamobile.com (Nokia WAP Gateway 4.1 CD1/ECD13_D/4.1.04)
		"http://monternet.com",//移动梦网的网关，例如：Via=WTP/1.1 BJBJ-PS-WAP1-GW08.bj1.monternet.com. (Nokia WAP Gateway 4.1 CD1/ECD13_E/4.1.05)
		...
		"http://wap.lizongbo.com",//自己测试时模拟的头信息
...
//		boolean testUsePc = true;//暂时只用PC端页面
//		if (testUsePc) {
//			return false;
//		}
